...
const (
	...
	managerServiceName = "AmnesiaWGHelper"
	...
	helperPipe = `\\.\pipe\ProtectedPrefix\Administrators\AmnesiaWG\helper`
)

// dirs is everything the helper keeps on disk, under C:\ProgramData\AmnesiaWG:
//
